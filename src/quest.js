...
6d. ⚠️⚠️ **绝不许编"具体的凭证"，也不许靠它推进剧情**（2026-09-18 用户截图报的）：
   ...
   · ✅ 这一条对**任何角色**都成立（初华、睦、海铃…）：别给他们编联系方式。
...
export function briefFor(groupId = '') {
  ...
  // ⚠️⚠️ 2026-09-18 改（用户截图：HZY 问「你不是说去菜场那边看看吗」，
  ...
  return [
    ...
    recent.length
      // ⚠️⚠️ 2026-09-18 改措辞（用户截图：HZY 问「你不是说去菜场那边看看吗」，
    ...
    //    HZY 问「你不是说去菜场那边看看吗」，她答「我哪说去菜场了……哦，你说**她**买菜那事」——
